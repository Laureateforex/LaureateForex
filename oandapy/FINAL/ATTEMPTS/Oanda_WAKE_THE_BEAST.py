...
api = API(access_token="49c68257ae0870c5b76bbe63d4c79803-bc876dfcc6b0ebcc31ef73e45ebdbab8")
...
# show the endpoint as it is constructed for this call print("REQUEST:{}".format(r))
rv = api.request(r)
...
if __name__ == "__main__":
    ...
    for i in instruments:
        if rsi_d_calc(i) > 66 and rsi_h_calc(i) > 66:
            print("buy: ", i) and requests.post(url, data=instruments, json=i)
        elif rsi_d_calc(i) < 33 and rsi_h_calc(i) < 33:
            print("sell: ", i)
        else:
            for ob in order_buy_calc(i, atr_calc(i)):
                ro = orders.OrderCreate(accountID=accountID, data=json.dumps(ob))
